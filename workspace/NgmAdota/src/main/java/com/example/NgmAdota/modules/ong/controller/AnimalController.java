...
public class AnimalController {
    ...
    @PostMapping("/")
    public ResponseEntity<ResponseAnimalDTO> createAnimal(@Valid @RequestBody RequestAnimalDTO animalDTO) {
        ResponseAnimalDTO createdAnimal = createAnimalService.execute(animalDTO);
